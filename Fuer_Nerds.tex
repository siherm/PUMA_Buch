...
\end{enumerate}
\subsection{Duplikatserkennung\index{Duplikat}} 
...
Integrieren Sie Publikationslisten (z.B. Ihre eigenen Publikationen), die das gleiche Format haben wie in PUMA, auf Ihrer Webseite. Dazu müssen Sie ein iframe in Ihren HTML-Code\index{HTML} einfügen, das folgendermaßen aussieht:\newline %Screenshot
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=8cm]{Bilder/extension_manager}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=11cm]{Bilder/available_extensions}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=8cm]{Bilder/reiter_general}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=9cm]{Bilder/reiter_plugin}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=7cm]{Bilder/csl_typo}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=11cm]{Bilder/stylesheets}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=11cm]{Bilder/csl_stylesheet}}
...
%\newline\newline
%\textbf{Nutzer}\newline
\subsection{Bitbucket\index{Bitbucket}}
