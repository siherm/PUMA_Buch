...
\textbf{Word\index{Export!Word}} \index{Word} \label{exportWord}
\begin{enumerate}
...
\end{enumerate}
\textbf{Citavi\index{Export!Citavi}}\label{exportCitavi}
\begin{enumerate}
...
\textbf{Zotero\index{Export!Zotero}}\label{exportZotero}
\begin{enumerate}
...
\end{enumerate} 
\textbf{JabRef\index{Export!JabRef}}\label{exportJabref}
\begin{enumerate}
...
\textbf{Literaturverwaltungsprogramm Citavi\index{Import!Citavi}}\label{importCitavi} 
\begin{enumerate}
...
\newline
\textbf{Literaturverwaltungsprogramm Zotero\index{Import!Zotero}} \label{importZotero}
\newline \newline
...
\end{enumerate}  
\textbf{Literaturverwaltungsprogramm JabRef\index{Import!JabRef}\index{JabRef}}\label{importJabRef}
\begin{enumerate}
