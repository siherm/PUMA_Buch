...
\begin{figure}[h!]
 ...
 \label{figure3}
\end{figure}
\begin{mdframed}[style=mdfexample1,frametitle={TIPP},backgroundcolor=gray!40] Der Gebrauch des BibTex-Formates\index{BibTex} ist zu empfehlen, da dieses Format sehr verbreitet ist.
\end{mdframed}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=10cm]{Bilder/eintraege_auswaehlen}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=11cm]{Bilder/citavi_schritt2}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=11cm]{Bilder/citavi_schritt3}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=11cm]{Bilder/citavi_schritt4}}
 \caption{Speicherort}
 \label{figure114}
\end{figure}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=11cm]{Bilder/citavi_schritt5}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=5cm]{Bilder/citavi_schritt6}}
 \caption{Export bestätigen}
 \label{figure118}
\end{figure}
\end{enumerate}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=9cm]{Bilder/import_von_zotero_2}}
...
\begin{figure}[h!]
 \centering
 \fbox{\includegraphics[width=10cm]{Bilder/import_von_zotero_3}}
...
\begin{mdframed}[style=mdfexample1,frametitle={ACHTUNG},backgroundcolor=gray!40]Das weitere Vorgehen ist exemplarisch, es richtet sich sowohl nach Ihrem Webbrowser als auch nach Ihrem RSS-Reader. Im gezeigten Fall übernimmt der Browser \enquote{Mozilla Firefox} sowohl die Aufgabe des Webbrowsers als auch die des RSS-Readers.
\end{mdframed}
...
\begin{figure}[h!]
 ...
 \label{figure3}
\end{figure}
\subsection{Universitätsbibliografie\index{Unibibliografie}}
